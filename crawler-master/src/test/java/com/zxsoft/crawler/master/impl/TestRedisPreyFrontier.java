...
public class TestRedisPreyFrontier {
	...
	public void testAddPrey() {
		...
		Prey prey = new Prey("http://www.baidu.com", "http://tieba.baidu.com/f?ie=utf-8&kw=%E8%9A%8C%E5%9F%A0",
		        SlaveManager.JobType.NETWORK_INSPECT.toString(), "001", 1,
		        System.currentTimeMillis());
		frontier.pushPrey(prey);
		prey = new Prey("http://www.sina.com.cn", "http://roll.news.sina.com.cn/s/channel.php",
		        SlaveManager.JobType.NETWORK_INSPECT.toString(),"001",  3,
		        System.currentTimeMillis());
		frontier.pushPrey(prey);
		prey = new Prey("http://bbs.anhuinews.com", "http://bbs.anhuinews.com/forum.php?mod=forumdisplay&fid=319&filter=lastpost&orderby=lastpost",
		        SlaveManager.JobType.NETWORK_INSPECT.toString(), "001", 5,
		        System.currentTimeMillis());
		frontier.pushPrey(prey);
	}
