package com.zxsoft.crawler.indexer.impl;
...
public class RestIndexWriter implements IndexWriter {

	private Logger LOG = LoggerFactory.getLogger(RestIndexWriter.class);
