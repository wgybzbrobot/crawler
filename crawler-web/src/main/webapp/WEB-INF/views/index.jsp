...
<body>
	...
	<div>
		<input class="easyui-searchbox" data-options="prompt:'输入网站名称',searcher:doSearch" style="width: 200px" /> 
	...
	<div class="form-wrapper" style="display: none;">
		...
		<div class="form-wrapper-center">
			<form id="websiteForm" method="post" action="website/add" data-options="novalidate:true">
				...
				<div>
					<label class="form-label" for="sitetype">网站类型</label> <select class="easyui-validatebox form-input" name="sitetype">
	...
	<div id="content">
		<ul>
			<c:forEach items="${page.res}" var="web">
				<li class="site-li"><a href="section?sitebase64=${web.sitebase64}&comment=${web.comment}" title="${web.site}">${web.comment }</a><span
					style="font-size: 6px; color: #e3e3e3;"><a id="${web.sitebase64}" class="moreinfo"
