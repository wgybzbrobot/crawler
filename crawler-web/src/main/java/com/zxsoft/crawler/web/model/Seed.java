...
public class Seed implements Serializable , Cloneable{
	...
	public Seed(String url, String indexUrl, int remain, int type, String title, Date releasedate, String mainUrl) {
	    super();
	    this.url = url;
	...
	public Seed(int type, String url, String indexUrl, String mainUrl, String title, Date releasedate, boolean lose,
            int fetchinterval, Date lastfetchtime, int remain) {
	    super();
	    this.type = type;
	    this.url = url;
	    this.indexUrl = indexUrl;
