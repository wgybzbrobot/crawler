...
public class SourceExtractorParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "FILTER", "WITHESPACE", "WS", "Source_Token1"
	};
	public static final int
		RULE_extractSource = 0;
	...
	public SourceExtractorParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class ExtractSourceContext extends ParserRuleContext {
		public TerminalNode Source_Token1() { return getToken(SourceExtractorParser.Source_Token1, 0); }
	...
	public final ExtractSourceContext extractSource() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_extractSource);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2); match(Source_Token1);
			}
		}
