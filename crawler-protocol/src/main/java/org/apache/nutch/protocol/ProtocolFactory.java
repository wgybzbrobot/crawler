...
public class ProtocolFactory {
  ...
  public Collection<WebPageMy.Field> getFields() {
    Collection<WebPageMy.Field> fields = new HashSet<WebPageMy.Field>();
    for (Extension extension : this.extensionPoint.getExtensions()) {
      Protocol protocol;
      try {
        protocol = (Protocol) extension.getExtensionInstance();
        Collection<WebPageMy.Field> pluginFields = protocol.getFields();
