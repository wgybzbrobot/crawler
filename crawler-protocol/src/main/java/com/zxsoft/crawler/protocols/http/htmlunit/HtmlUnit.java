...
//                 client.waitForBackgroundJavaScript(15000);
        ...
        private HtmlPage makeRequest(WebPage page) throws FailingHttpStatusCodeException, IOException {
                ...
                if (useProxy) {
                        ...
                        // credentialsProvider.addCredentials(proxyUsername,
                        // proxyPassword);
                }
        ...
        protected Response loadPrevPage(int pageNum, WebPage page) throws IOException, PageBarNotFoundException {
                ...
                // String listdom = listConf == null ? null :
                // listConf.getListdom();
                // Element listElement = null;
                // if (!StringUtils.isEmpty(listConf)) {
                // listElement =
                // CollectionUtils.isEmpty(document.select(listdom)) ? null :
                // document.select(listdom).first();
                // }
        ...
        protected Response loadNextPage(int pageNum, WebPage page) throws IOException, PageBarNotFoundException {
                ...
                URL url = null;
                // if (htmlPage == null ||
                // !urlStr.equals(htmlPage.getUrl().toExternalForm())) {
                try {
                        url = new URL(urlStr);
                        htmlPage = makeRequest(page);
                } catch (FailingHttpStatusCodeException | IOException e) {
        ...
        protected Response loadLastPage(WebPage page) throws IOException, PageBarNotFoundException {
                ...
                if (!CollectionUtils.isEmpty(elements)) {
                        ...
                        Element pagebar = getPageBar(/* listElement == null ? */document /*
                                                                                          * :
                                                                                          * listElement
                                                                                          */);
                        if (pagebar == null)
        ...
        public static void main(String[] args) throws FailingHttpStatusCodeException, IOException {
                ...
                // webClient.getAjaxController().processSynchron(page, request,
                // false);
