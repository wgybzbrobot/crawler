...
public class HttpClientPageHelperTest {
    ...
    public void testLoadLastPage() throws IOException, PageBarNotFoundException {
        ...
        WebPage page = new WebPage(currentDoc.location(), false, currentDoc);
        ...
        Assert.isTrue(protocolOutput.getDocument().location()
                        .matches("http://tieba.baidu.com/p/3171682576\\?pn=\\d+"));
    }

    @Test
    public void testLoadPrevPage() throws IOException, PrevPageNotFoundException,
                    PageBarNotFoundException {
        Document currentDoc = Jsoup.connect("http://tieba.baidu.com/p/3171682576?pn=3")
                        .get();
        WebPage page = new WebPage(currentDoc.location(), false, currentDoc);
        ...
        Assert.notNull(protocolOutput.getDocument());
        Assert.isTrue(protocolOutput.getDocument().location()
                        .equals("http://tieba.baidu.com/p/3171682576?pn=2"));
    }
